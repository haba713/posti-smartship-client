...
public class StoredShipmentInfo {
    ...
    public StoredShipmentInfo withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public StoredShipmentInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public StoredShipmentInfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public StoredShipmentInfo withOrderNo(String orderNo) {
        this.orderNo = orderNo;
        return this;
    }
    ...
    public StoredShipmentInfo withReference(String reference) {
        this.reference = reference;
        return this;
    }
    ...
    public StoredShipmentInfo withServiceId(String serviceId) {
        this.serviceId = serviceId;
        return this;
    }
    ...
    public StoredShipmentInfo withParcelCount(Integer parcelCount) {
        this.parcelCount = parcelCount;
        return this;
    }
    ...
    public StoredShipmentInfo withSndName(String sndName) {
        this.sndName = sndName;
        return this;
    }
    ...
    public StoredShipmentInfo withSndZipcode(String sndZipcode) {
        this.sndZipcode = sndZipcode;
        return this;
    }
    ...
    public StoredShipmentInfo withSndCity(String sndCity) {
        this.sndCity = sndCity;
        return this;
    }
    ...
    public StoredShipmentInfo withSndCountry(String sndCountry) {
        this.sndCountry = sndCountry;
        return this;
    }
    ...
    public StoredShipmentInfo withRcvName(String rcvName) {
        this.rcvName = rcvName;
        return this;
    }
    ...
    public StoredShipmentInfo withRcvZipcode(String rcvZipcode) {
        this.rcvZipcode = rcvZipcode;
        return this;
    }
    ...
    public StoredShipmentInfo withRcvCity(String rcvCity) {
        this.rcvCity = rcvCity;
        return this;
    }
    ...
    public StoredShipmentInfo withRcvCountry(String rcvCountry) {
        this.rcvCountry = rcvCountry;
        return this;
    }
    ...
    public StoredShipmentInfo withCreated(Date created) {
        this.created = created;
        return this;
    }
    ...
    public StoredShipmentInfo withChanged(Date changed) {
        this.changed = changed;
        return this;
    }
    ...
    public StoredShipmentInfo withShipDate(Date shipDate) {
        this.shipDate = shipDate;
        return this;
    }
    ...
    public StoredShipmentInfo withReturnShipment(Boolean returnShipment) {
        this.returnShipment = returnShipment;
        return this;
    }
    ...
    public StoredShipmentInfo withNormalShipment(Boolean normalShipment) {
        this.normalShipment = normalShipment;
        return this;
    }
    ...
    public StoredShipmentInfo withStatuses(List<Status> statuses) {
        this.statuses = statuses;
        return this;
    }
    ...
    public StoredShipmentInfo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
