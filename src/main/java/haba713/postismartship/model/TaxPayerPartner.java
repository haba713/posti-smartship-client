...
public class TaxPayerPartner {
    ...
    public TaxPayerPartner withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public TaxPayerPartner withAgentNo(String agentNo) {
        this.agentNo = agentNo;
        return this;
    }
    ...
    public TaxPayerPartner withCustNo(String custNo) {
        this.custNo = custNo;
        return this;
    }
    ...
    public TaxPayerPartner withCustNoIssuerCode(String custNoIssuerCode) {
        this.custNoIssuerCode = custNoIssuerCode;
        return this;
    }
    ...
    public TaxPayerPartner withPalletRegNo(String palletRegNo) {
        this.palletRegNo = palletRegNo;
        return this;
    }
    ...
    public TaxPayerPartner withEdiAddress(String ediAddress) {
        this.ediAddress = ediAddress;
        return this;
    }
    ...
    public TaxPayerPartner withSenderId(String senderId) {
        this.senderId = senderId;
        return this;
    }
    ...
    public TaxPayerPartner withBookingId(String bookingId) {
        this.bookingId = bookingId;
        return this;
    }
    ...
    public TaxPayerPartner withBookingOffice(String bookingOffice) {
        this.bookingOffice = bookingOffice;
        return this;
    }
    ...
    public TaxPayerPartner withBookingEmail(String bookingEmail) {
        this.bookingEmail = bookingEmail;
        return this;
    }
    ...
    public TaxPayerPartner withSourceCode(String sourceCode) {
        this.sourceCode = sourceCode;
        return this;
    }
    ...
    public TaxPayerPartner withEdiUserId(String ediUserId) {
        this.ediUserId = ediUserId;
        return this;
    }
    ...
    public TaxPayerPartner withEdiPassword(String ediPassword) {
        this.ediPassword = ediPassword;
        return this;
    }
    ...
    public TaxPayerPartner withEdiKey(String ediKey) {
        this.ediKey = ediKey;
        return this;
    }
    ...
    public TaxPayerPartner withExternalIdentifier(String externalIdentifier) {
        this.externalIdentifier = externalIdentifier;
        return this;
    }
    ...
    public TaxPayerPartner withPriceEnquiry(String priceEnquiry) {
        this.priceEnquiry = priceEnquiry;
        return this;
    }
    ...
    public TaxPayerPartner withAdditionalCarrierLabel(Boolean additionalCarrierLabel) {
        this.additionalCarrierLabel = additionalCarrierLabel;
        return this;
    }
    ...
    public TaxPayerPartner withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
