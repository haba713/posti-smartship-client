...
public class CustomsPayerPartner {
    ...
    public CustomsPayerPartner withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public CustomsPayerPartner withAgentNo(String agentNo) {
        this.agentNo = agentNo;
        return this;
    }
    ...
    public CustomsPayerPartner withCustNo(String custNo) {
        this.custNo = custNo;
        return this;
    }
    ...
    public CustomsPayerPartner withCustNoIssuerCode(String custNoIssuerCode) {
        this.custNoIssuerCode = custNoIssuerCode;
        return this;
    }
    ...
    public CustomsPayerPartner withPalletRegNo(String palletRegNo) {
        this.palletRegNo = palletRegNo;
        return this;
    }
    ...
    public CustomsPayerPartner withEdiAddress(String ediAddress) {
        this.ediAddress = ediAddress;
        return this;
    }
    ...
    public CustomsPayerPartner withSenderId(String senderId) {
        this.senderId = senderId;
        return this;
    }
    ...
    public CustomsPayerPartner withBookingId(String bookingId) {
        this.bookingId = bookingId;
        return this;
    }
    ...
    public CustomsPayerPartner withBookingOffice(String bookingOffice) {
        this.bookingOffice = bookingOffice;
        return this;
    }
    ...
    public CustomsPayerPartner withBookingEmail(String bookingEmail) {
        this.bookingEmail = bookingEmail;
        return this;
    }
    ...
    public CustomsPayerPartner withSourceCode(String sourceCode) {
        this.sourceCode = sourceCode;
        return this;
    }
    ...
    public CustomsPayerPartner withEdiUserId(String ediUserId) {
        this.ediUserId = ediUserId;
        return this;
    }
    ...
    public CustomsPayerPartner withEdiPassword(String ediPassword) {
        this.ediPassword = ediPassword;
        return this;
    }
    ...
    public CustomsPayerPartner withEdiKey(String ediKey) {
        this.ediKey = ediKey;
        return this;
    }
    ...
    public CustomsPayerPartner withExternalIdentifier(String externalIdentifier) {
        this.externalIdentifier = externalIdentifier;
        return this;
    }
    ...
    public CustomsPayerPartner withPriceEnquiry(String priceEnquiry) {
        this.priceEnquiry = priceEnquiry;
        return this;
    }
    ...
    public CustomsPayerPartner withAdditionalCarrierLabel(Boolean additionalCarrierLabel) {
        this.additionalCarrierLabel = additionalCarrierLabel;
        return this;
    }
    ...
    public CustomsPayerPartner withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
