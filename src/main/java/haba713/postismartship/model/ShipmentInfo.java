...
public class ShipmentInfo {
    ...
    public ShipmentInfo withHref(String href) {
        this.href = href;
        return this;
    }
    ...
    public ShipmentInfo withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public ShipmentInfo withStatus(String status) {
        this.status = status;
        return this;
    }
    ...
    public ShipmentInfo withShipmentNo(String shipmentNo) {
        this.shipmentNo = shipmentNo;
        return this;
    }
    ...
    public ShipmentInfo withOrderNo(String orderNo) {
        this.orderNo = orderNo;
        return this;
    }
    ...
    public ShipmentInfo withReference(String reference) {
        this.reference = reference;
        return this;
    }
    ...
    public ShipmentInfo withServiceId(String serviceId) {
        this.serviceId = serviceId;
        return this;
    }
    ...
    public ShipmentInfo withParcelCount(Double parcelCount) {
        this.parcelCount = parcelCount;
        return this;
    }
    ...
    public ShipmentInfo withSndName(String sndName) {
        this.sndName = sndName;
        return this;
    }
    ...
    public ShipmentInfo withSndZipcode(String sndZipcode) {
        this.sndZipcode = sndZipcode;
        return this;
    }
    ...
    public ShipmentInfo withSndCity(String sndCity) {
        this.sndCity = sndCity;
        return this;
    }
    ...
    public ShipmentInfo withSndCountry(String sndCountry) {
        this.sndCountry = sndCountry;
        return this;
    }
    ...
    public ShipmentInfo withRcvName(String rcvName) {
        this.rcvName = rcvName;
        return this;
    }
    ...
    public ShipmentInfo withRcvZipcode(String rcvZipcode) {
        this.rcvZipcode = rcvZipcode;
        return this;
    }
    ...
    public ShipmentInfo withRcvCity(String rcvCity) {
        this.rcvCity = rcvCity;
        return this;
    }
    ...
    public ShipmentInfo withRcvCountry(String rcvCountry) {
        this.rcvCountry = rcvCountry;
        return this;
    }
    ...
    public ShipmentInfo withCreated(Date created) {
        this.created = created;
        return this;
    }
    ...
    public ShipmentInfo withChanged(Date changed) {
        this.changed = changed;
        return this;
    }
    ...
    public ShipmentInfo withShipDate(Date shipDate) {
        this.shipDate = shipDate;
        return this;
    }
    ...
    public ShipmentInfo withReturnShipment(Boolean returnShipment) {
        this.returnShipment = returnShipment;
        return this;
    }
    ...
    public ShipmentInfo withNormalShipment(Boolean normalShipment) {
        this.normalShipment = normalShipment;
        return this;
    }
    ...
    public ShipmentInfo withConsolidated(Boolean consolidated) {
        this.consolidated = consolidated;
        return this;
    }
    ...
    public ShipmentInfo withParcels(List<Parcel> parcels) {
        this.parcels = parcels;
        return this;
    }
    ...
    public ShipmentInfo withPdfs(List<Pdf> pdfs) {
        this.pdfs = pdfs;
        return this;
    }
    ...
    public ShipmentInfo withPreviousPdfs(List<PreviousPdf> previousPdfs) {
        this.previousPdfs = previousPdfs;
        return this;
    }
    ...
    public ShipmentInfo withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
