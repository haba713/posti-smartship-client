...
public class SenderPartner {
    ...
    public SenderPartner withId(String id) {
        this.id = id;
        return this;
    }
    ...
    public SenderPartner withAgentNo(String agentNo) {
        this.agentNo = agentNo;
        return this;
    }
    ...
    public SenderPartner withCustNo(String custNo) {
        this.custNo = custNo;
        return this;
    }
    ...
    public SenderPartner withCustNoIssuerCode(String custNoIssuerCode) {
        this.custNoIssuerCode = custNoIssuerCode;
        return this;
    }
    ...
    public SenderPartner withPalletRegNo(String palletRegNo) {
        this.palletRegNo = palletRegNo;
        return this;
    }
    ...
    public SenderPartner withEdiAddress(String ediAddress) {
        this.ediAddress = ediAddress;
        return this;
    }
    ...
    public SenderPartner withSenderId(String senderId) {
        this.senderId = senderId;
        return this;
    }
    ...
    public SenderPartner withBookingId(String bookingId) {
        this.bookingId = bookingId;
        return this;
    }
    ...
    public SenderPartner withBookingOffice(String bookingOffice) {
        this.bookingOffice = bookingOffice;
        return this;
    }
    ...
    public SenderPartner withBookingEmail(String bookingEmail) {
        this.bookingEmail = bookingEmail;
        return this;
    }
    ...
    public SenderPartner withSourceCode(String sourceCode) {
        this.sourceCode = sourceCode;
        return this;
    }
    ...
    public SenderPartner withEdiUserId(String ediUserId) {
        this.ediUserId = ediUserId;
        return this;
    }
    ...
    public SenderPartner withEdiPassword(String ediPassword) {
        this.ediPassword = ediPassword;
        return this;
    }
    ...
    public SenderPartner withEdiKey(String ediKey) {
        this.ediKey = ediKey;
        return this;
    }
    ...
    public SenderPartner withExternalIdentifier(String externalIdentifier) {
        this.externalIdentifier = externalIdentifier;
        return this;
    }
    ...
    public SenderPartner withPriceEnquiry(String priceEnquiry) {
        this.priceEnquiry = priceEnquiry;
        return this;
    }
    ...
    public SenderPartner withAdditionalCarrierLabel(Boolean additionalCarrierLabel) {
        this.additionalCarrierLabel = additionalCarrierLabel;
        return this;
    }
    ...
    public SenderPartner withAdditionalProperty(String name, Object value) {
        this.additionalProperties.put(name, value);
        return this;
    }
